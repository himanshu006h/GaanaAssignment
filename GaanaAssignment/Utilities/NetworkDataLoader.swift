...
struct NetworkDataLoaderConstant {
    static let baseUrlString = "https://demo3033278.mockable.io/gaanaDriveTest"
...
class NetworkDataLoader {
    ...
    func loadResult(urlString: String = NetworkDataLoaderConstant.baseUrlString, serviceType: ServiceType = ServiceType.drive
    ...
    private func parseData(_ data: Data, serviceType: ServiceType = ServiceType.drive, completion: QueryCompletionHandler) {
        switch serviceType {
        case .drive:
            do {
                let feedInfo = try decoder.decode(GaanaBase.self, from: data)
